...
<head>
    ...
    <link rel="stylesheet" href="css/Ed-quality.css">
      ...
      <div class="container">
        ...
        <form>
            <div class="form-group">
                <label for="text">المؤهل الدراسي</label>
                <input type="text" class="form-control" id="text" placeholder="">
              </div>
          
          <div class="form-group">
            <label for="text">الجامعة أو المؤسسة التعليمية</label>
            <input type="text" class="form-control" id="text" placeholder="">
          </div>
          <div class="form-group">
            <label for="number">عدد سنوات الدراسة</label>
