      ...
      <div class="container">
        ...
        <form>
            <div class="form-group">
                <label for="text">اسم الدورة</label>
                <input type="text" class="form-control" id="text" placeholder="">
              </div>
          
          <div class="form-group">
            <label for="text">الجهة التعليمية</label>
            <input type="text" class="form-control" id="text" placeholder="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="number">فترة التدريب</label>
            <input type="number" class="form-control" id="number" placeholder="">
          </div>
          <div class="form-group">
            <label for="text">الشهادة المعتمدة</label>
            
                <input type="file" class="form-control" name="myFile"> 
               
          </div>
          
          <button type="submit" class="btn btn-default" ><a href="cv.html">التالي</a></button>
        </form>
      </div>
