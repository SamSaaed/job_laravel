...
<body>
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="{{ url('/create_detalis')}}" id="navbardrop" data-toggle="dropdown">
              وظائف حسب المجال
            </a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="#">Link 1</a>
...
<div class="container-fluid p-5 bg-info text-white text-center">
    <h1>يمن كوم</h1>
    <h2>موقع متخصص لتوفير وظائف بكافة المجالات</h2> 
  </div>
    
  <div class="container mt-5">
    <div class="row">
      <div class="col-sm-4">
        <h3>معلمة قران كريم للسيدات والاطفال</h3>
        <img src="images/7.JPG">
        <p> وظائف خالية  ·  اناث  ·  يوم كامل  ·  تربية وتعليم  ·  تحفيظ قرآن
            الراتب الأساسي: 27000 - 32000 
            مميزات الوظيفة: يُحتسب الوقت الإضافي , تأمينات اجتماعية</p>
        <p>مركز الزهراء لتعليم القران الكريم</p>
      </div>
      <div class="col-sm-4 bg-info">
        <h3>مدرس رياضيات</h3>
        <img src="images/6.JPG">
        <p> وظائف خالية  ·  عمل من المنزل  ·  تربية وتعليم  ·  تدريس
            الراتب الأساسي: 4000 - 5000 ريال سعودي</p>
        <p>جامعة العرب</p>
      </div>
      <div class="col-sm-4">
        <h3>مدير عام </h3>    
        <img src="images/8.JPG">    
        <p> - 15 سنوات خبره  ·  1 وظيفة خالية  ·  يوم كامل  ·  تربية وتعليم  ·  ادارة مدارس
            الراتب الأساسي: قابل للتفاوض
            مميزات الوظيفة: توفير سكن</p>
        <p>مدير عام مدارس المكلا الحديثة</p>
      </div>
    </div>
  </div>
