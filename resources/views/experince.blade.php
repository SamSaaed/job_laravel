...
<head>
    ...
    <link rel="stylesheet" href="css/experince.css">
      ...
      <div class="container">
        ...
        <form>
            <div class="form-group">
                <label for="text">اسم المهنة</label>
                <input type="text" class="form-control" id="text" placeholder="">
              </div>
          <div class="form-group">
            <label for="number">عدد سنوات الخبرة </label>
            <input type="number" class="form-control" id="number" placeholder="">
          </div>
          <div class="form-group">
            <label for="text">جهة العمل</label>
            <input type="text" class="form-control" id="text" placeholder="">
          </div>
          <div class="form-group">
            <label for="number">تاريخ البدء</label>
            <input type="number" class="form-control" id="number" placeholder="">
          </div>
          <div class="form-group">
            <label for="number">تاريخ الانتهاء</label>
            <input type="number" class="form-control" id="number" placeholder="">
          </div>
          
          <button type="submit" class="btn btn-default" ><a href="skills.html">التالي</a></button>
        </form>
      </div>
