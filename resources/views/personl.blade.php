      ...
      <div class="container">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="text" placeholder="ادخل اسمك">
              </div>
          <div class="form-group">
            <label for="email">الايميل </label>
            <input type="email" class="form-control" id="email" placeholder="ادخل ايميلك">
          </div>
          <div class="form-group">
            <label for="pwd">كلمة المرور</label>
            <input type="password" class="form-control" id="pwd" placeholder="ادخل كلمة المرور">
          </div>
          <div class="form-group">
            <label for="pwd">رقم الهاتف</label>
            <input type="number" class="form-control" id="number" placeholder="ادخل رقم الهاتف">
          </div>
          <div class="form-group">
            <label for="pwd">رقم بطاقة الهوية</label>
            <input type="number" class="form-control" id="number" placeholder="">
          </div>
          <div class="form-group">
            <label for="text">الموقع</label>
            <input type="text" class="form-control" id="text" placeholder="ادخل موقعك">
          </div>
          <div class="checkbox">
            <label><input type="checkbox"> هل تذكرني</label>
          </div>
          <button type="submit" class="btn btn-default"><a href="Ed-quality.html">التالي</a></button>
        </form>
      </div>
